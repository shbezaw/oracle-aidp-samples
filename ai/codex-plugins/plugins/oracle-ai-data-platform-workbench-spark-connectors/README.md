...
Install this directory as a local Codex plugin or add it to a Codex marketplace that points at this repository path. The plugin manifest lives at:

```
ai/codex-plugins/plugins/oracle-ai-data-platform-workbench-spark-connectors/.codex-plugin/plugin.json
```
...
In a Codex session against your Oracle AI Data Platform Workbench workspace, just describe what you want:
